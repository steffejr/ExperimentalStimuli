...
# -*- coding: utf-8 -*-
"""
This experiment was created using PsychoPy2 Experiment Builder (v1.80.03), Wed Sep 24 10:24:47 2014
...
expName = 'NumberSternberg'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath=u'/Users/jason/Dropbox/SteffenerColumbia/Scripts/ExperimentalStimuli/LetterSternberg/NumberSternberg.psyexp',
...
presentSet = visual.TextStim(win=win, ori=0, name='presentSet',
    ...
    pos=[0, 0], height=0.4, wrapWidth=3,
    color='white', colorSpace='rgb', opacity=1,
    depth=-1.0)
...
pracTrials = data.TrialHandler(nReps=1.0, method=u'random', 
    extraInfo=expInfo, originPath=u'/Users/jason/Dropbox/SteffenerColumbia/Scripts/ExperimentalStimuli/LetterSternberg/NumberSternberg.psyexp',

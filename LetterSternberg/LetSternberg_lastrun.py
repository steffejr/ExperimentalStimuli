...
# -*- coding: utf-8 -*-
"""
This experiment was created using PsychoPy2 Experiment Builder (v1.80.03), Sat Sep 20 21:20:54 2014
...
expName = u'LetSternberg'  # from the Builder filename that created this script
...
trials = data.TrialHandler(nReps=5, method=u'sequential', 
    ...
    trialList=data.importConditions(u'LetterSternbergConditions.xlsx'),

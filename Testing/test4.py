...
# -*- coding: utf-8 -*-
"""
This experiment was created using PsychoPy2 Experiment Builder (v1.81.01), Tue 28 Oct 2014 11:03:19 AM EDT
...
expName = u'test4'  # from the Builder filename that created this script
...
while continueRoutine:
    ...
    elif p_port.status == STARTED and t >= (0.0 + (1.0-win.monitorFramePeriod*0.75)): #most of one frame period left

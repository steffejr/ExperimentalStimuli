...
for thisTrial in trials:
    ...
    while continueRoutine:
        ...
        elif Label.status == STARTED and t >= (0.0 + (2-win.monitorFramePeriod*0.75)): #most of one frame period left
        ...
        elif text.status == STARTED and t >= (2 + (4-win.monitorFramePeriod*0.75)): #most of one frame period left
        ...
        elif text_3.status == STARTED and t >= (7 + (2-win.monitorFramePeriod*0.75)): #most of one frame period left
    ...
    while continueRoutine:
        ...
        if t > 0.0:
            pleasantness.draw()
            continueRoutine = pleasantness.noResponse
            if pleasantness.noResponse == False:
                pleasantness.response = pleasantness.getRating()
                pleasantness.rt = pleasantness.getRT()
    ...
    while continueRoutine:
        ...
        if t > 0.0:
            intensity.draw()
            continueRoutine = intensity.noResponse
            if intensity.noResponse == False:
                intensity.response = intensity.getRating()
                intensity.rt = intensity.getRT()
    ...
    while continueRoutine:
        ...
        if t > 0.0:
            edibility.draw()
            continueRoutine = edibility.noResponse
            if edibility.noResponse == False:
                edibility.response = edibility.getRating()
                edibility.rt = edibility.getRT()

...
# -*- coding: utf-8 -*-
"""
This experiment was created using PsychoPy2 Experiment Builder (v1.82.01), Wed 06 Jan 2016 09:39:10 AM EST
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath=u'/home/jason/Dropbox/SteffenerColumbia/Scripts/ExperimentalStimuli/PartialTrialDIR/Instructions.psyexp',
...
text_28 = visual.TextStim(win=win, ori=0, name='text_28',
    text="First ...\nLet's make sure the buttons work.\nPress the RIGHT INDEX Finger button.",    font='Arial',
...
text_29 = visual.TextStim(win=win, ori=0, name='text_29',
    text='Press the RIGHT MIDDLE Finger button.',    font='Arial',
    pos=[0, 0.4], height=0.1, wrapWidth=None,
    color='white', colorSpace='rgb', opacity=1,
    depth=0.0)
...
text_22 = visual.TextStim(win=win, ori=0, name='text_22',
    text='You will also see a cross hair on the screen',    font='Arial',
    pos=[0, 0.8], height=0.1, wrapWidth=None,
    color='white', colorSpace='rgb', opacity=1,
    depth=-15.0)
text_23 = visual.TextStim(win=win, ori=0, name='text_23',
    text='Either Green',    font='Arial',
    pos=[0, 0.8], height=0.1, wrapWidth=None,
    color='white', colorSpace='rgb', opacity=1,
    depth=-16.0)
text_24 = visual.TextStim(win=win, ori=0, name='text_24',
    text='Or RED',    font='Arial',
    pos=[0, 0.8], height=0.1, wrapWidth=None,
    color='white', colorSpace='rgb', opacity=1,
    depth=-17.0)
...
text_2 = visual.TextStim(win=win, ori=0, name='text_2',
    text='For this experiment you will see letters at the top of the screen.',    font='Arial',
    units='norm', pos=[0, 0.8], height=0.1, wrapWidth=1.1,
    color='white', colorSpace='rgb', opacity=1,
    depth=0.0)
text = visual.TextStim(win=win, ori=0, name='text',
    text='Some of the letters will be enclosed by brackets.',    font='Arial',
    pos=[0, 0.8], height=0.1, wrapWidth=None,
    color='white', colorSpace='rgb', opacity=1,
    depth=-1.0)
text_6 = visual.TextStim(win=win, ori=0, name='text_6',
    text='These are the TWO letters to remember.',    font='Arial',
    pos=[0, 0.8], height=0.1, wrapWidth=None,
    color='white', colorSpace='rgb', opacity=1,
    depth=-2.0)
text_4 = visual.TextStim(win=win, ori=0, name='text_4',
    text='The letters will be removed, focus on the green cross hair.',    font='Arial',
    pos=[0, 0.8], height=0.1, wrapWidth=None,
    color='white', colorSpace='rgb', opacity=1,
    depth=-3.0)
...
text_11 = visual.TextStim(win=win, ori=0, name='text_11',
    text=u"Let's Repeat",    font=u'Arial',
    pos=[0, 0.8], height=0.1, wrapWidth=None,
    color=u'white', colorSpace=u'rgb', opacity=1,
    depth=0.0)
text_12 = visual.TextStim(win=win, ori=0, name='text_12',
    text='Remember the letters B and C',    font='Arial',
    units='norm', pos=[0, 0.8], height=0.1, wrapWidth=1.25,
    color='white', colorSpace='rgb', opacity=1,
    depth=-1.0)
text_14 = visual.TextStim(win=win, ori=0, name='text_14',
    text='Letters are removed',    font='Arial',
    pos=[0, 0.8], height=0.1, wrapWidth=None,
    color='white', colorSpace='rgb', opacity=1,
    depth=-2.0)
...
text_17 = visual.TextStim(win=win, ori=0, name='text_17',
    text=u'Are you trying to remember the letter b?',    font=u'Arial',
    pos=[0, 0.8], height=0.1, wrapWidth=None,
    color=u'white', colorSpace=u'rgb', opacity=1,
    depth=-15.0)
text_19 = visual.TextStim(win=win, ori=0, name='text_19',
    text=u'Yes you are. You would press the INDEX finger button as quickly as possible.',    font=u'Arial',
    pos=[0, 0.8], height=0.1, wrapWidth=None,
    color=u'white', colorSpace=u'rgb', opacity=1,
    depth=-16.0)
text_20 = visual.TextStim(win=win, ori=0, name='text_20',
    text=u'The trial is over and the cross hair turns RED.',    font=u'Arial',
    pos=[0, 0.8], height=0.1, wrapWidth=None,
    color=u'white', colorSpace=u'rgb', opacity=1,
    depth=-17.0)
...
text_48 = visual.TextStim(win=win, ori=0, name='text_48',
    text=u'Respond as quickly as possible',    font=u'Arial',
    pos=[0, 0.8], height=0.1, wrapWidth=None,
    color=u'white', colorSpace=u'rgb', opacity=1,
    depth=-15.0)
...
text_15 = visual.TextStim(win=win, ori=0, name='text_15',
    text='The number of letters to remember',    font='Arial',
    pos=[0, 0.8], height=0.1, wrapWidth=None,
    color='white', colorSpace='rgb', opacity=1,
    depth=0.0)
text_33 = visual.TextStim(win=win, ori=0, name='text_33',
    text='Varies between 1 and 6',    font='Arial',
    units='norm', pos=[0, 0.8], height=0.1, wrapWidth=1.25,
    color='white', colorSpace='rgb', opacity=1,
    depth=-1.0)
text_34 = visual.TextStim(win=win, ori=0, name='text_34',
    text='There will always be six letters presented',    font='Arial',
    pos=[0, 0.8], height=0.1, wrapWidth=None,
    color='white', colorSpace='rgb', opacity=1,
    depth=-2.0)
text_3 = visual.TextStim(win=win, ori=0, name='text_3',
    text='It is the brackets that indicate which letters to remember.',    font='Arial',
    pos=[0, 0.8], height=0.1, wrapWidth=None,
    color='white', colorSpace='rgb', opacity=1,
    depth=-3.0)
text_35 = visual.TextStim(win=win, ori=0, name='text_35',
    text='Here are some examples',    font='Arial',
    pos=[0, 0.8], height=0.1, wrapWidth=None,
    color='white', colorSpace='rgb', opacity=1,
    depth=-4.0)
...
text_27 = visual.TextStim(win=win, ori=0, name='text_27',
    text='To help with the analysis of the brain data.\nSome trials are PARTIAL.',    font='Arial',
    pos=[0, 0.8], height=0.1, wrapWidth=None,
    color='white', colorSpace='rgb', opacity=1,
    depth=0.0)
text_30 = visual.TextStim(win=win, ori=0, name='text_30',
    text='All trials will have a set of leters to study.',    font='Arial',
    units='norm', pos=[0, 0.8], height=0.1, wrapWidth=1.25,
    color='white', colorSpace='rgb', opacity=1,
    depth=-1.0)
text_31 = visual.TextStim(win=win, ori=0, name='text_31',
    text='Some will not require a response',    font='Arial',
    pos=[0, 0.8], height=0.1, wrapWidth=None,
    color='white', colorSpace='rgb', opacity=1,
    depth=-2.0)
text_32 = visual.TextStim(win=win, ori=0, name='text_32',
    text='Some will have no delay between the letters to study and the response.',    font='Arial',
    units='norm', pos=[0, 0.8], height=0.1, wrapWidth=1.5,
    color='white', colorSpace='rgb', opacity=1,
    depth=-3.0)
ISI_16 = core.StaticPeriod(win=win, screenHz=expInfo['frameRate'], name='ISI_16')
TopUpperLine_16 = visual.Line(win=win, name='TopUpperLine_16',units='norm', 
    start=(-[2, 0.95][0]/2.0, 0), end=(+[2, 0.95][0]/2.0, 0),
    ori=0, pos=[0, 0.65],
    lineWidth=2, lineColor=[1,1,-1], lineColorSpace='rgb',
    fillColor='[1,1,-1]', fillColorSpace='rgb',
...
UpperBrackets_16 = visual.TextStim(win=win, ori=0, name='UpperBrackets_16',
    ...
    color='yellow', colorSpace='rgb', opacity=1,
    depth=-7.0)
BotUpperLine_16 = visual.Line(win=win, name='BotUpperLine_16',units='norm', 
    start=(-[2, 0.95][0]/2.0, 0), end=(+[2, 0.95][0]/2.0, 0),
    ori=0, pos=[0, 0.15],
    lineWidth=2, lineColor=[1,1,-1], lineColorSpace='rgb',
    fillColor='yellow', fillColorSpace='rgb',
    opacity=1,interpolate=True)
TopLowerLine_16 = visual.Line(win=win, name='TopLowerLine_16',units='norm', 
    start=(-[2, 0.5][0]/2.0, 0), end=(+[2, 0.5][0]/2.0, 0),
    ori=0, pos=[0, -0.15],
    lineWidth=2, lineColor='cyan', lineColorSpace='rgb',
    fillColor='cyan', fillColorSpace='rgb',
...
LowerBrackets_16 = visual.TextStim(win=win, ori=0, name='LowerBrackets_16',
    ...
    color='cyan', colorSpace='rgb', opacity=1,
    depth=-11.0)
BotLowerLine_16 = visual.Line(win=win, name='BotLowerLine_16',units='norm', 
    start=(-[2, 0.5][0]/2.0, 0), end=(+[2, 0.5][0]/2.0, 0),
    ori=0, pos=[0, -0.65],
    lineWidth=2, lineColor='cyan', lineColorSpace='rgb',
    fillColor='cyan', fillColorSpace='rgb',
...
text_36 = visual.TextStim(win=win, ori=0, name='text_36',
    text='What is important is that when the crosshair turns RED. The trial is over.',    font='Arial',
    units='norm', pos=[0, 0.8], height=0.1, wrapWidth=1.5,
    color='white', colorSpace='rgb', opacity=1,
    depth=-15.0)
text_37 = visual.TextStim(win=win, ori=0, name='text_37',
    text='Try to forget any of the studied letters and wait for the next trial',    font='Arial',
    units='norm', pos=[0, 0.8], height=0.1, wrapWidth=1.5,
    color='white', colorSpace='rgb', opacity=1,
    depth=-16.0)
...
trials = data.TrialHandler(nReps=10, method='sequential', 
    extraInfo=expInfo, originPath=u'/home/jason/Dropbox/SteffenerColumbia/Scripts/ExperimentalStimuli/PartialTrialDIR/Instructions.psyexp',
    trialList=[None],
    ...
    while continueRoutine and routineTimer.getTime() > 0:
        ...
        if key_resp_2.status == STARTED:
            ...
            if len(theseKeys) > 0:  # at least one key was pressed
                ...
                # was this 'correct'?
                if (key_resp_2.keys == str('6')) or (key_resp_2.keys == '6'):
                    key_resp_2.corr = 1
                else:
                    key_resp_2.corr = 0
    ...
    while continueRoutine and routineTimer.getTime() > 0:
        ...
        if key_resp_3.status == STARTED:
            ...
            if len(theseKeys) > 0:  # at least one key was pressed
                ...
                # was this 'correct'?
                if (key_resp_3.keys == str('7')) or (key_resp_3.keys == '7'):
                    key_resp_3.corr = 1
                else:
                    key_resp_3.corr = 0
                # a response ends the routine
...
while continueRoutine and routineTimer.getTime() > 0:
    ...
    elif TopUpperLine_16.status == STARTED and t >= (0 + (20-win.monitorFramePeriod*0.75)): #most of one frame period left
    ...
    elif BotUpperLine_16.status == STARTED and t >= (0.0 + (20-win.monitorFramePeriod*0.75)): #most of one frame period left
    ...
    elif TopLowerLine_16.status == STARTED and t >= (0.0 + (20-win.monitorFramePeriod*0.75)): #most of one frame period left
    ...
    elif BotLowerLine_16.status == STARTED and t >= (0.0 + (20-win.monitorFramePeriod*0.75)): #most of one frame period left
...
while continueRoutine and routineTimer.getTime() > 0:
    ...
    if t >= 7 and resp.status == NOT_STARTED:
        ...
        event.clearEvents(eventType='keyboard')
    elif resp.status == STARTED and t >= (7 + (2-win.monitorFramePeriod*0.75)): #most of one frame period left
        resp.status = STOPPED

...
# -*- coding: utf-8 -*-
"""
This experiment was created using PsychoPy2 Experiment Builder (v1.81.01), Thu 24 Sep 2015 10:48:47 AM EDT
...
UpperText = visual.TextStim(win=win, ori=0, name='UpperText',
    ...
    units=u'norm', pos=[0, 0.4], height=0.3, wrapWidth=2,
...
for thisTrial in trials:
    ...
    # In order to get brackets to be a different color from the letters I 
    # created a second text element with the appropriate color.
    # In order to get the brackets to overlap in the correct spots, between
    # the letters I used a monospaced font, Courier. Then For each trial I set 
    # up the text for the letters and the brackets. These get displayed 

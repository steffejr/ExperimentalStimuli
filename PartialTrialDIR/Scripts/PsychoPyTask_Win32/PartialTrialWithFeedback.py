...
INPUTFILE = 'TrialList7Loads6Repeats.xlsx'
...
for thisTrial in trials:
    ...
    if UpBrack > 0:
        ...
        for i in range(0,15,1):   ## Changed from 13 when using 7 letters

...
#        float(df.KeyboardResp_rt[30][1:-1])
    ...
    def areResponsesCorrect(self):
        ...
        self.Yes = '7'
        self.No = '8'
        # Responses the file thinks are yes and no
        self.ExpectYes = 6
        self.ExpectNo = 7
...
def concatTwoDataFrames(dataFrame1, dataFrame2):
    # Concat the two files and calculate their performance acros the two files.
...
def createSPMDesignMatrix(dataFrame, OutFileName):
    ...
    LoadLevels = numpy.unique(dataFrame.data.LoadLevels) 
    # Load level 1
    TrialsToKeep = (dataFrame.data.LoadLevels==1) & (dataFrame.data.Acc != -1)
    S1on = numpy.array(dataFrame.data.TrialStart[TrialsToKeep]) - TimeShift
    S1dur = numpy.array(dataFrame.data.StimDur[TrialsToKeep])
    TrialsToKeep = (dataFrame.data.LoadLevels==1) & (dataFrame.data.RetDur > 0) & (dataFrame.data.Acc != -1)
    ...
    TrialsToKeep = (dataFrame.data.LoadLevels==1) & (dataFrame.data.ProbeDur > 0) & (dataFrame.data.Acc != -1)
    ...
    # Load level 2
    TrialsToKeep = (dataFrame.data.LoadLevels==2) & (dataFrame.data.Acc != -1)
    S2on = numpy.array(dataFrame.data.TrialStart[TrialsToKeep]) - TimeShift
    S2dur = numpy.array(dataFrame.data.StimDur[TrialsToKeep])
    TrialsToKeep = (dataFrame.data.LoadLevels==2) & (dataFrame.data.RetDur > 0) & (dataFrame.data.Acc != -1)
    ...
    TrialsToKeep = (dataFrame.data.LoadLevels==2) & (dataFrame.data.ProbeDur > 0) & (dataFrame.data.Acc != -1)
    ...
    # Load level 3
    TrialsToKeep = (dataFrame.data.LoadLevels==3) & (dataFrame.data.Acc != -1)
    S3on = numpy.array(dataFrame.data.TrialStart[TrialsToKeep]) - TimeShift
    S3dur = numpy.array(dataFrame.data.StimDur[TrialsToKeep])
    TrialsToKeep = (dataFrame.data.LoadLevels==3) & (dataFrame.data.RetDur > 0) & (dataFrame.data.Acc != -1)
    ...
    TrialsToKeep = (dataFrame.data.LoadLevels==3) & (dataFrame.data.ProbeDur > 0) & (dataFrame.data.Acc != -1)
    ...
    # Load level 4
    TrialsToKeep = (dataFrame.data.LoadLevels==4) & (dataFrame.data.Acc != -1)
    S4on = numpy.array(dataFrame.data.TrialStart[TrialsToKeep]) - TimeShift
    S4dur = numpy.array(dataFrame.data.StimDur[TrialsToKeep])
    TrialsToKeep = (dataFrame.data.LoadLevels==4) & (dataFrame.data.RetDur > 0) & (dataFrame.data.Acc != -1)
    ...
    TrialsToKeep = (dataFrame.data.LoadLevels==4) & (dataFrame.data.ProbeDur > 0) & (dataFrame.data.Acc != -1)
    ...
    # Load level 5
    TrialsToKeep = (dataFrame.data.LoadLevels==5) & (dataFrame.data.Acc != -1)
    S5on = numpy.array(dataFrame.data.TrialStart[TrialsToKeep]) - TimeShift
    S5dur = numpy.array(dataFrame.data.StimDur[TrialsToKeep])
    TrialsToKeep = (dataFrame.data.LoadLevels==5) & (dataFrame.data.RetDur > 0) & (dataFrame.data.Acc != -1)
    ...
    TrialsToKeep = (dataFrame.data.LoadLevels==5) & (dataFrame.data.ProbeDur > 0) & (dataFrame.data.Acc != -1)
    ...
    # Load level 6
    TrialsToKeep = (dataFrame.data.LoadLevels==6) & (dataFrame.data.Acc != -1)
    S6on = numpy.array(dataFrame.data.TrialStart[TrialsToKeep]) - TimeShift
    S6dur = numpy.array(dataFrame.data.StimDur[TrialsToKeep])
    TrialsToKeep = (dataFrame.data.LoadLevels==6) & (dataFrame.data.RetDur > 0) & (dataFrame.data.Acc != -1)
    ...
    TrialsToKeep = (dataFrame.data.LoadLevels==6) & (dataFrame.data.ProbeDur > 0) & (dataFrame.data.Acc != -1)

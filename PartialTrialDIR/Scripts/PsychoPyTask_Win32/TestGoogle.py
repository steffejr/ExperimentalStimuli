...
def openWorkBook():
    # where is the autherntication file
    file = '/Users/jason/Dropbox/SteffenerColumbia/Scripts/ExperimentalStimuli/PartialTrialDIR/Scripts/PartialTrialData-84690d0d6711.json'
...
def createWorksheet(workBook, subid):
    ...
    wkB.add_worksheet(title=worksheetName, rows="100", cols="20")

...
# -*- coding: utf-8 -*-
"""
This experiment was created using PsychoPy2 Experiment Builder (v1.81.00), January 15, 2016, at 08:17
...
text = visual.TextStim(win=win, ori=0, name='text',
    ...
    units='norm', pos=[0, 0.4], height=0.2, wrapWidth=1.7,
